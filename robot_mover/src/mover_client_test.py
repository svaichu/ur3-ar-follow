...
def main():
    ...
    pose1.pose.position = Point(-0.535, 0.135, 0.2)  
    pose1.pose.orientation = Quaternion(0,0,0,1)
    
    

    pose2.header.frame_id = "base_link" 
    pose2.pose.position = Point(-0.37, 0.135, 0.2)  
    pose2.pose.orientation = Quaternion(0,0,0,1)  
    

    pose3.header.frame_id = "base_link" 
    pose3.pose.position = Point(-0.34, 0.11, 0.2)  
    pose3.pose.orientation = Quaternion(0,0,0,1)  
    
    pose4.header.frame_id = "base_link" 
    pose4.pose.position = Point(-0.34, -0.055, 0.2)  
    pose4.pose.orientation = Quaternion(0,0,0,1) 
    
    pose5.header.frame_id = "base_link" 
    pose5.pose.position = Point(-0.46, 0.03, 0.2)  
    pose5.pose.orientation = Quaternion(0,0,0,1)
    
    pose6.header.frame_id = "base_link" 
    pose6.pose.position = Point(-0.46, -0.1, 0.2)  
    pose6.pose.orientation = Quaternion(0,0,0,1)
    
    pose7.header.frame_id = "base_link" 
    pose7.pose.position = Point(-0.38, 0.09, 0.2)  
    pose7.pose.orientation = Quaternion(0,0,0,1)
